...
# One of those functions is zip() which allows us to quickly combine associated data-sets without needing to rely on multi-dimensional lists.
...
print(names_and_heights)  # Would output: <zip object at 0x7f1631e86b48>
...
# Would output: [('Jenny', 61), ('Alexus', 70), ('Sam', 67), ('Grace', 65)]
